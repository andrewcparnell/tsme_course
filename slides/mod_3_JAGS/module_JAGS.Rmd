...
- Over thousands and thousands of iterations it should eventually converge towards the most likely parmaeter values
...
- We start the algorithm from mutliple different starting values. This is known as running multiple _chains_
