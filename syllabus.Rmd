...
# Module 6: ARIMAX and Seasonal models (AP)
...
8. Choosing different models: DIC
9. The components of DIC 
10. Other model selection techniques
11. Example: choosing the order of an ARIMAX model 
12. Time series in the frequency domain
13. Methods for estimating seasonal models
13. Estimating frequencies via a Fourier model
14. JAGS code for a Fourier model
15. Example: the Lynx data
16. Individual vs joint frequency models
17. Plotting hte periodogram
18. Bayesian vs traditional frequency analysis
19. Summary
...
# Module 7: Models with changing variance: ARCH, GARCH and Stochastic Volatility Models (AP)
...
6. Example model run
7. NA values in JAGS models
8. The NA trick for producing fitted values
9. The NA trick for producing forecasts
...
# Module 10: Extensions: state space models, change point modelling, and multivariate time series (AP)
