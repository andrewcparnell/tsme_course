---
title: "Tiem Series for Climatologists and Ecologists: Syllabus"
...
S20. General tips: build one model for all the data, use informative priors, check your model
...
# Practical: Revision of R and introduction to JAGS (DM)
Tuesday 10th May 14:00-15:30

------

# AR(1) models and Random walks (DM)
Wednesday 11th May 9:15-10:00

------

# ARIMA models (AP): rename to MA and ARIMA models (AP)
...
# sARIMA and ARIMAX (AP): rename to ARIMAX and Seasonal models
...
# Practical: Fitting ARIMA models in JAGS (DM)
Wednesday 11th May 14:00-15:30

------

# Stochastic volatility models and Brownian motion (AP): rename to Models with changing variance: ARCH, GARCH and Stochastic Volatility Models
...
# Gaussian processes for time series (DM)
Thursday 12th May 10:45-11:30

------

# Fitting Gaussian processes in JAGS (DM)
Thursday 12th May 12:00-12:45 and 14:00-15:00

------

#Change-point modelling (AP): rename to Models for continuous time series
...
- Fit multiple change point models and compare between them
...
# Extensions: multivariate time series and long-memory processes (AP): rename to Extensions: state space models, change point modelling, and multivariate time series (AP)
