...
2. Use the ```plot()```, print() and ```traceplot()``` functions on your ```model_run``` object to check the output.  
...
1. With the simulated data, experiment with changing the value of T when creating the data? What happens to the posterior distribution of the parameters as T gets bigger?
